...
def is_valid(puzzle, guess, row, col):
    ...
    # and then the square
    # this is tricks, but we want to get where the 3x3 square starts
...
def solve_sudoku(puzzle):
    ...
    # our puzzle is a list lf lists, where each inner list is a row in our sudoku puzzle
    # return whether a solution exists
    # mutates puzzle to be the solution (if solution exists)

    # step 1: choose somewhere on the puzzle ro make a guess
    ...
    # step 6: if none of the numbers that we try work, then rhis puzzle is UNSOLVABLE!!
    return False
